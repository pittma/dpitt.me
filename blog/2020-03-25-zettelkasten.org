...
Dropbox]]. When I switched to Emacs about 2 years ago and started using
...
file(s). However, about a week ago I encountered [[https://www.srid.ca/2010101.html][~neuron~]] in the
...
which I promptly devoured and, well, it I /had/ to do it. Please read
...
furniture with index card drawers, six-by-six, like one those bygone
cabinets you used to see at the library for filing books' locations
with Dewey Decimal Classification. In that zettelkästen those index
cards followed these rules:
...
Aha! A system. What kind of programmer would I didn't automate as much
...
thought from my head to my fingers with as few barriers as possible. I
ended up with this small bash script that I put on my path:
...
In terms of new code, this is just extent of it for this Org
...
always end up deleting everything because no organizational scheme I
...
I'm not inundated with an entire list almost ever.

Using my zettelkästen stirs up that nostalgic feeling of going through
an old notebook every time I open it, and I'm only confronted with the
ideas I've asked it about. It narrows the aperture on a topic in a way
